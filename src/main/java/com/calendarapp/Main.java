...
public class Main {
    ...
    private static void createEvent(Scanner scanner, EventStore store) throws IOException {
        ...
        RecurrenceRule rule = promptRecurrence(scanner, event.getId());
        if (rule != null) {
    ...
    private static RecurrenceRule promptRecurrence(Scanner scanner, int eventId) {
        ...
        return RecurrenceRule.parse(eventId, interval, times, endDate);
    }
